...
- (void)sendWithSaveAttempt:(BOOL)saveAttempt;
- (void)stop;
@end
...
- (CaptureResult * _Nonnull)executeWithDataToSend:(NSDictionary<NSString *, id> * _Nonnull)dataToSend token:(NSString * _Nonnull)token SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface FreeToken : NSObject <NSItemProviderReading, NSItemProviderWriting>
...
- (void)openCameraFaceTecWithViewController:(UIViewController * _Nonnull)viewController completion:(void (^ _Nonnull)(CaptureResult * _Nullable, ErrorBio * _Nullable))completion;
- (void)successFacetecProcessorWithResult:(NSDictionary<NSString *, id> * _Nonnull)result;
- (void)unsuccessfulFacetecProcessorWithStatus:(FaceTecSessionStatus)status;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
