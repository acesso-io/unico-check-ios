...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "AcessoBio", path: "./Sources/AcessoBio.xcframework"),
        .binaryTarget(name: "FaceTecSDK", path: "./Sources/FaceTecSDK.xcframework"),
        .binaryTarget(name: "CryptoSwift", path: "./Sources/CryptoSwift.xcframework")
    ]
)
